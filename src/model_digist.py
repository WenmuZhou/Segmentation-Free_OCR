...
from .resnet import resnet_pool
...
def crnn_fn(features, labels, mode, params):
    ...
    conv = resnet_pool(features['images'], (mode == tf.estimator.ModeKeys.TRAIN), summaries=False)
    ...
    if mode == tf.estimator.ModeKeys.EVAL:
        with tf.name_scope('evaluation'):
            ...
            tf.identity(accuracy, name='eval_accuracy')
